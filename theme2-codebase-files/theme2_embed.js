...
function show_web_landing_notification(auto_pop_up_text) {

    var notification_message_div = '<div class="notification-message-div" id="notification-message-div">\
                ...
                <div class="allincall-notification-message" onclick="open_up_bot()" >\
    ...
    notification_counter='<div class="allincall-notification-div" onclick="open_up_bot()" id="allincall-notification-count">1</div>'
                        ...
                        if (web_landing_list[i]["show_prompt_message_after_timer"] == 'true') {
                            ...
                            setTimeout(function(e) {
                                if (chat_bot_maximized == false) {
                                    setTimeout(function(e) {
                                            show_web_landing_notification(prompt_message);
                                        }, 800)
                                }
...
function load_easychat_bot() {
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            var easychat_popup_close_button = document.createElement("span");
                ...
                easychat_popup_close_button.innerHTML='<svg width="14" style="margin-top: 13px;" height="14" viewBox="0 0 14 14" fill="white" xmlns="http://www.w3.org/2000/svg">\
                    <path d="M12.7305 14L7.0045 8.26864L1.27846 14L0 12.7224L5.73505 7L0 1.27763L1.27846 0L7.0045 5.73136L12.7305 0.00899763L14 1.27763L8.27396 7L14 12.7224L12.7305 14Z" fill="white"/>\
                </svg>'
            ...
            if (is_minimization_enabled) {
                ...
                easychat_popup_maximize.innerHTML = '<svg width="11" height="8"  viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg" style="padding-top: 5px">\
            ...
            if(auto_popup_type == "2"){
             ...
             notification_message_div = '<div class="notification-message-div notification-message-div-intent-bubble" style="display:none;" id="notification-message-div">\
                ...
                <div class="notification-message-intent-bubble" onclick="open_up_bot()" >\
            ...
            document.body.appendChild(easychat_popup_close_button);
            if (is_minimization_enabled) {
